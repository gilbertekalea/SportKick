...
class Client:
    ...
    def prepare_authorization_request(
        self, authorization_url, state=None, redirect_url=None, scope=None, **kwargs
    ):
    ...
    def prepare_token_request(
        ...
        **kwargs
        ...
        body = self.prepare_request_body(
            body=body, redirect_uri=self.redirect_url, **kwargs
        )

        return token_url, FORM_ENC_HEADERS, body

    def prepare_refresh_token_request(
        self, token_url, refresh_token=None, body="", scope=None, **kwargs
    ):
        ...
        # do not assign scope to self automatically anymore
        scope = self.scope if scope is None else scope
        body = self.prepare_refresh_body(
    ...
    def _populate_attributes(self, response):
        warnings.warn(
            "Please switch to the public method " "populate_token_attributes.",
            DeprecationWarning,
        )
