...
def zone_for_name(
    name, rdclass: int = rdataclass.IN, tcp=False, resolver: Optional[Resolver] = None
): ...

class Resolver:
    def __init__(
        self,
        filename: Optional[str] = "/etc/resolv.conf",
    ...
    def resolve(
        self,
        qname: str,
        rdtype: Union[int, str] = rdatatype.A,
