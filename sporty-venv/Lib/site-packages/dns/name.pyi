...
class Name:
    ...
    def to_wire(
        self, file=None, compress=None, origin=None, canonicalize=False
    ) -> Optional[bytes]: ...
    ...
    def choose_relativity(
        self, origin: Optional[Name] = None, relativize=True
    ) -> Name: ...
...
def from_text(
    text, origin: Optional[Name] = Name("."), idna_codec: Optional[IDNACodec] = None
) -> Name: ...
