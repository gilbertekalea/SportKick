...
class Update(message.Message):
    def __init__(
        self,
        zone: Union[name.Name, str],
        rdclass: Union[int, str] = rdataclass.IN,
        keyring: Optional[Dict[name.Name, bytes]] = None,
        keyname: Optional[name.Name] = None,
        keyalgorithm: Optional[name.Name] = tsig.default_algorithm,
    ) -> None:
        self.id: int
    ...
    def to_wire(
        self, origin: Optional[name.Name] = None, max_size=65535, **kw
    ) -> bytes: ...
